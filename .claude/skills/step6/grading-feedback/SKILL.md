---
skill_id: grading-feedback
implements_agent: agents/step6/grading-feedback.md
model_tier: sonnet
---

# Skill: Grading & Feedback
...
Reads: static-analysis-report.md, security-audit-report.md, test-report.md
Writes: step6/grading-report.md
