---
skill_id: code-graph-bootstrap
implements_agent: agents/prework/code-graph-bootstrap.md
model_tier: haiku
---

# Skill: Code Graph Bootstrap

## Implementation Logic
Binds the code knowledge-graph MCP provider OR declares text-scan fallback mode for this run

Reads: Repo root path, config/mcp/code-graph-provider.yaml
Writes: prework/code-graph-status.md
