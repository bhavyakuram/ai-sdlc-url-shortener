---
skill_id: technical-design
implements_agent: agents/step3/technical-design.md
model_tier: opus
---
...
Reads: feature-spec.md, acceptance-criteria.md, architecture-context.md
Writes: step3/technical-design.md
